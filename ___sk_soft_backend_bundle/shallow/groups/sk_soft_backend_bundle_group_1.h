...
class SK_SoftBackend_Bundle_Data_Group_1 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 1;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {303376};
    
    size_t data_size = 303376;
    unsigned char data[303376] = {};

    SK_SoftBackend_Bundle_Data_Group_1() {
