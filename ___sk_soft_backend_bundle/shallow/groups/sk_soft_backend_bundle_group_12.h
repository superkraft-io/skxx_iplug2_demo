...
class SK_SoftBackend_Bundle_Data_Group_12 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 12;
    
    size_t offsets[2] = {0,217156};
    size_t sizes[2] = {217156,18301};
    
    size_t data_size = 235457;
    unsigned char data[235457] = {};

    SK_SoftBackend_Bundle_Data_Group_12() {
