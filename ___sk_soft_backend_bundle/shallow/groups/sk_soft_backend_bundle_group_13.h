...
class SK_SoftBackend_Bundle_Data_Group_13 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 13;
    
    size_t offsets[10] = {0,153464,155509,184957,188503,197012,202469,207102,218107,234441};
    size_t sizes[10] = {153464,2045,29448,3546,8509,5457,4633,11005,16334,26692};
    
    size_t data_size = 261133;
    unsigned char data[261133] = {};

    SK_SoftBackend_Bundle_Data_Group_13() {
