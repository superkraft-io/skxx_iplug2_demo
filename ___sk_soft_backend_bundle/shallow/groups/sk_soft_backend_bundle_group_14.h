...
class SK_SoftBackend_Bundle_Data_Group_14 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 14;
    
    size_t offsets[12] = {0,224465,233185,237922,240109,242556,243893,251629,253901,262041,266699,268874};
    size_t sizes[12] = {224465,8720,4737,2187,2447,1337,7736,2272,8140,4658,2175,3346};
    
    size_t data_size = 272220;
    unsigned char data[272220] = {};

    SK_SoftBackend_Bundle_Data_Group_14() {
