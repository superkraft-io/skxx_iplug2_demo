...
class SK_SoftBackend_Bundle_Data_Group_2 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 2;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {403245};
    
    size_t data_size = 403245;
    unsigned char data[403245] = {};

    SK_SoftBackend_Bundle_Data_Group_2() {
