...
class SK_SoftBackend_Bundle_Data_Group_23 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 23;
    
    size_t offsets[4] = {0,7919,18939,117745};
    size_t sizes[4] = {7919,11020,98806,181451};
    
    size_t data_size = 299196;
    unsigned char data[299196] = {};

    SK_SoftBackend_Bundle_Data_Group_23() {
