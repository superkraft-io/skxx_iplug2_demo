...
class SK_SoftBackend_Bundle_Data_Group_26 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 26;
    
    size_t offsets[4] = {0,25998,104218,182602};
    size_t sizes[4] = {25998,78220,78384,78620};
    
    size_t data_size = 261222;
    unsigned char data[261222] = {};

    SK_SoftBackend_Bundle_Data_Group_26() {
