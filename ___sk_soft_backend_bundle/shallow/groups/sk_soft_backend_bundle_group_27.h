...
class SK_SoftBackend_Bundle_Data_Group_27 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 27;
    
    size_t offsets[12] = {0,78628,157128,167963,193735,202192,209529,213439,215448,270185,286132,288358};
    size_t sizes[12] = {78628,78500,10835,25772,8457,7337,3910,2009,54737,15947,2226,1336};
    
    size_t data_size = 289694;
    unsigned char data[289694] = {};

    SK_SoftBackend_Bundle_Data_Group_27() {
