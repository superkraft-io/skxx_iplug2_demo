...
class SK_SoftBackend_Bundle_Data_Group_28 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 28;
    
    size_t offsets[4] = {0,101781,187465,194994};
    size_t sizes[4] = {101781,85684,7529,100852};
    
    size_t data_size = 295846;
    unsigned char data[295846] = {};

    SK_SoftBackend_Bundle_Data_Group_28() {
