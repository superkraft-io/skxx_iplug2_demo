...
class SK_SoftBackend_Bundle_Data_Group_3 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 3;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {1647205};
    
    size_t data_size = 1647205;
    unsigned char data[1647205] = {};

    SK_SoftBackend_Bundle_Data_Group_3() {
