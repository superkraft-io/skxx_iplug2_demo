...
class SK_SoftBackend_Bundle_Data_Group_30 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 30;
    
    size_t offsets[2] = {0,50287};
    size_t sizes[2] = {50287,217470};
    
    size_t data_size = 267757;
    unsigned char data[267757] = {};

    SK_SoftBackend_Bundle_Data_Group_30() {
