...
class SK_SoftBackend_Bundle_Data_Group_32 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 32;
    
    size_t offsets[6] = {0,68232,76268,98573,150387,248507};
    size_t sizes[6] = {68232,8036,22305,51814,98120,42756};
    
    size_t data_size = 291263;
    unsigned char data[291263] = {};

    SK_SoftBackend_Bundle_Data_Group_32() {
