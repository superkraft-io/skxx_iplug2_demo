...
class SK_SoftBackend_Bundle_Data_Group_33 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 33;
    
    size_t offsets[5] = {0,28173,95609,150538,165340};
    size_t sizes[5] = {28173,67436,54929,14802,11073};
    
    size_t data_size = 176413;
    unsigned char data[176413] = {};

    SK_SoftBackend_Bundle_Data_Group_33() {
