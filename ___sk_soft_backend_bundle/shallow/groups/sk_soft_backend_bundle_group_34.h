...
class SK_SoftBackend_Bundle_Data_Group_34 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 34;
    
    size_t offsets[4] = {0,130845,239328,245067};
    size_t sizes[4] = {130845,108483,5739,3972};
    
    size_t data_size = 249039;
    unsigned char data[249039] = {};

    SK_SoftBackend_Bundle_Data_Group_34() {
