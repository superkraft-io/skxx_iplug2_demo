...
class SK_SoftBackend_Bundle_Data_Group_35 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 35;
    
    size_t offsets[10] = {0,53299,98982,109719,116911,162103,197329,219450,236188,261796};
    size_t sizes[10] = {53299,45683,10737,7192,45192,35226,22121,16738,25608,22561};
    
    size_t data_size = 284357;
    unsigned char data[284357] = {};

    SK_SoftBackend_Bundle_Data_Group_35() {
