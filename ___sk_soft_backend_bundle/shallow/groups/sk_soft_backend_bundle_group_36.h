...
class SK_SoftBackend_Bundle_Data_Group_36 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 36;
    
    size_t offsets[14] = {0,47290,83349,97552,108638,124491,197784,209294,232634,237694,260523,264001,271096,275931};
    size_t sizes[14] = {47290,36059,14203,11086,15853,73293,11510,23340,5060,22829,3478,7095,4835,3674};
    
    size_t data_size = 279605;
    unsigned char data[279605] = {};

    SK_SoftBackend_Bundle_Data_Group_36() {
