...
class SK_SoftBackend_Bundle_Data_Group_40 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 40;
    
    size_t offsets[8] = {0,43879,44732,57181,171595,268523,270834,272594};
    size_t sizes[8] = {43879,853,12449,114414,96928,2311,1760,20750};
    
    size_t data_size = 293344;
    unsigned char data[293344] = {};

    SK_SoftBackend_Bundle_Data_Group_40() {
