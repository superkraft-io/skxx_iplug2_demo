...
class SK_SoftBackend_Bundle_Data_Group_41 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 41;
    
    size_t offsets[11] = {0,43173,60951,74750,94972,138471,152881,165895,220462,237091,261767};
    size_t sizes[11] = {43173,17778,13799,20222,43499,14410,13014,54567,16629,24676,20444};
    
    size_t data_size = 282211;
    unsigned char data[282211] = {};

    SK_SoftBackend_Bundle_Data_Group_41() {
