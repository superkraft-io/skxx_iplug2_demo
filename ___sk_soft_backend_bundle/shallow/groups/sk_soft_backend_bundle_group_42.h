...
class SK_SoftBackend_Bundle_Data_Group_42 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 42;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {291164};
    
    size_t data_size = 291164;
    unsigned char data[291164] = {};

    SK_SoftBackend_Bundle_Data_Group_42() {
