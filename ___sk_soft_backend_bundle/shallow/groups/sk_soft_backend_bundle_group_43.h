...
class SK_SoftBackend_Bundle_Data_Group_43 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 43;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {178868};
    
    size_t data_size = 178868;
    unsigned char data[178868] = {};

    SK_SoftBackend_Bundle_Data_Group_43() {
