...
class SK_SoftBackend_Bundle_Data_Group_44 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 44;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {188332};
    
    size_t data_size = 188332;
    unsigned char data[188332] = {};

    SK_SoftBackend_Bundle_Data_Group_44() {
