...
class SK_SoftBackend_Bundle_Data_Group_45 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 45;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {190608};
    
    size_t data_size = 190608;
    unsigned char data[190608] = {};

    SK_SoftBackend_Bundle_Data_Group_45() {
