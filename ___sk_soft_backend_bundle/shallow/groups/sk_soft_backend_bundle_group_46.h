...
class SK_SoftBackend_Bundle_Data_Group_46 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 46;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {290956};
    
    size_t data_size = 290956;
    unsigned char data[290956] = {};

    SK_SoftBackend_Bundle_Data_Group_46() {
