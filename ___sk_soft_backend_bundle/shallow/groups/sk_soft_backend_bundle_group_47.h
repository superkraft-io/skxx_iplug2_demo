...
class SK_SoftBackend_Bundle_Data_Group_47 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 47;
    
    size_t offsets[3] = {0,178044,223460};
    size_t sizes[3] = {178044,45416,33616};
    
    size_t data_size = 257076;
    unsigned char data[257076] = {};

    SK_SoftBackend_Bundle_Data_Group_47() {
