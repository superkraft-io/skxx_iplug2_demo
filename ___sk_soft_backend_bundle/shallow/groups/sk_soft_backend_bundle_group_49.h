...
class SK_SoftBackend_Bundle_Data_Group_49 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 49;
    
    size_t offsets[3] = {0,89988,166724};
    size_t sizes[3] = {89988,76736,101648};
    
    size_t data_size = 268372;
    unsigned char data[268372] = {};

    SK_SoftBackend_Bundle_Data_Group_49() {
