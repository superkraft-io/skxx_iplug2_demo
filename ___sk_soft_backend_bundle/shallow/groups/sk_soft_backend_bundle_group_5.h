...
class SK_SoftBackend_Bundle_Data_Group_5 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 5;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {1955615};
    
    size_t data_size = 1955615;
    unsigned char data[1955615] = {};

    SK_SoftBackend_Bundle_Data_Group_5() {
