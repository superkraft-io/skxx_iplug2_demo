...
class SK_SoftBackend_Bundle_Data_Group_50 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 50;
    
    size_t offsets[13] = {0,78268,94544,107768,135891,153663,167799,225419,269719,278256,279606,291851,292946};
    size_t sizes[13] = {78268,16276,13224,28123,17772,14136,57620,44300,8537,1350,12245,1095,190};
    
    size_t data_size = 293136;
    unsigned char data[293136] = {};

    SK_SoftBackend_Bundle_Data_Group_50() {
