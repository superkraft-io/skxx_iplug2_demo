...
class SK_SoftBackend_Bundle_Data_Group_51 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 51;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {287630};
    
    size_t data_size = 287630;
    unsigned char data[287630] = {};

    SK_SoftBackend_Bundle_Data_Group_51() {
