...
class SK_SoftBackend_Bundle_Data_Group_52 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 52;
    
    size_t offsets[2] = {0,89476};
    size_t sizes[2] = {89476,137974};
    
    size_t data_size = 227450;
    unsigned char data[227450] = {};

    SK_SoftBackend_Bundle_Data_Group_52() {
