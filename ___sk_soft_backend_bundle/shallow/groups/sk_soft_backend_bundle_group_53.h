...
class SK_SoftBackend_Bundle_Data_Group_53 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 53;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {234458};
    
    size_t data_size = 234458;
    unsigned char data[234458] = {};

    SK_SoftBackend_Bundle_Data_Group_53() {
