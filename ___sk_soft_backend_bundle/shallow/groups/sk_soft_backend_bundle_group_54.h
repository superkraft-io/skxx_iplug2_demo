...
class SK_SoftBackend_Bundle_Data_Group_54 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 54;
    
    size_t offsets[5] = {0,72380,182750,184355,254894};
    size_t sizes[5] = {72380,110370,1605,70539,20239};
    
    size_t data_size = 275133;
    unsigned char data[275133] = {};

    SK_SoftBackend_Bundle_Data_Group_54() {
