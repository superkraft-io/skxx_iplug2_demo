...
class SK_SoftBackend_Bundle_Data_Group_55 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 55;
    
    size_t offsets[3] = {0,31100,45343};
    size_t sizes[3] = {31100,14243,1817};
    
    size_t data_size = 47160;
    unsigned char data[47160] = {};

    SK_SoftBackend_Bundle_Data_Group_55() {
