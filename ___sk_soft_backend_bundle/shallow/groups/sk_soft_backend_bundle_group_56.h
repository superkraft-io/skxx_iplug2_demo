...
class SK_SoftBackend_Bundle_Data_Group_56 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 56;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {288580};
    
    size_t data_size = 288580;
    unsigned char data[288580] = {};

    SK_SoftBackend_Bundle_Data_Group_56() {
