...
class SK_SoftBackend_Bundle_Data_Group_57 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 57;
    
    size_t offsets[4] = {0,24229,27097,214968};
    size_t sizes[4] = {24229,2868,187871,2202};
    
    size_t data_size = 217170;
    unsigned char data[217170] = {};

    SK_SoftBackend_Bundle_Data_Group_57() {
