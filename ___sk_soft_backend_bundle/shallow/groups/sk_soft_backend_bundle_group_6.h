...
class SK_SoftBackend_Bundle_Data_Group_6 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 6;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {686105};
    
    size_t data_size = 686105;
    unsigned char data[686105] = {};

    SK_SoftBackend_Bundle_Data_Group_6() {
