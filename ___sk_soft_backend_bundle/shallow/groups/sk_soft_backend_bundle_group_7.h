...
class SK_SoftBackend_Bundle_Data_Group_7 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 7;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {734253};
    
    size_t data_size = 734253;
    unsigned char data[734253] = {};

    SK_SoftBackend_Bundle_Data_Group_7() {
