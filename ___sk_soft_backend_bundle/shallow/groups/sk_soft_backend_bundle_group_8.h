...
class SK_SoftBackend_Bundle_Data_Group_8 : public SK_SoftBackend_Bundle_Data_Group_Root {
public:
    unsigned int groupID = 8;
    
    size_t offsets[1] = {0};
    size_t sizes[1] = {400195};
    
    size_t data_size = 400195;
    unsigned char data[400195] = {};

    SK_SoftBackend_Bundle_Data_Group_8() {
