...
#include "./groups/sk_soft_backend_bundle_group_0.h"
...
public:
    ...
    std::map<std::string, SK_SoftBackend_Bundle_Entry_Info*> fileEntries {
       {"/config.json", new SK_SoftBackend_Bundle_Entry_Info(0, 80, 0, 0, groups[0], false, "config.json", "")},
       {"/main.js", new SK_SoftBackend_Bundle_Entry_Info(80, 4425, 0, 1, groups[0], false, "main.js", "")}
    ...
    std::map<std::string, SK_SoftBackend_Bundle_Entry_Info*> folderEntries {
       ...
       {"/superkraft", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "complexity,engines,frontend,modules,sk_emptyEJS.ejs,sk_rootEngine.js,sk_rootViewCore.js,sk_superkraft.js,template.ejs,ui")},
       ...
       {"/superkraft/complexity/frontend", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "codeEditor,comm.js,complexity.css,complexity.js,editor,icons.js,selectionManager.js")},
       {"/superkraft/complexity/frontend/codeEditor", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "bakery.js,codeEditor.js,codemirror")},
       {"/superkraft/complexity/frontend/codeEditor/codemirror", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", ".editorconfig,.npmignore,AUTHORS,LICENSE,addon,bin,demo,doc,index.html,keymap,lib,mode,package.json,rollup.config.js,src,test,theme")},
       ...
       {"/superkraft/complexity/frontend/codeEditor/codemirror/doc", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "activebookmark.js,docs.css,internals.html,logo.png,logo.svg,logos,manual.html,realworld.html,releases.html,reporting.html,source_sans.woff,upgrade_v2.2.html,upgrade_v3.html,upgrade_v4.html,yinyang.png")},
       ...
       {"/superkraft/complexity/frontend/codeEditor/codemirror/src", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "addon,codemirror.js,display,edit,input,line,measurement,model,modes.js,util")},
       ...
       {"/superkraft/engines/dapp", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "engine.js,frontend,global_actions,modules,rootView.js")},
       ...
       {"/superkraft/engines/skxx", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "engine.js,frontend,global_actions,modules,rootView.js,rootView_bkp.js")},
       {"/superkraft/engines/skxx/frontend", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "engine_body.ejs,engine_style.css,sk_ui")},
       ...
       {"/superkraft/engines/wapp", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "engine.js,global_actions,modules,rootView.js")},
       ...
       {"/superkraft/frontend/libs", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "fastclick.js,fonts,formantic-ui,helpers,jquery,js-cookie,jsom,progressbarjs,sk_childMngr,sk_comm,sk_commands,sk_cursor,sk_dialog,sk_fileDrop,sk_helpers.js,sk_hint,sk_l10n,sk_mobile,sk_repeater.js,sk_shortcuts,sk_thread.js,sk_titlebar,sk_tween.js,sk_ums,sk_viewController,sortable.min.js,ua_parser")},
       ...
       {"/superkraft/frontend/libs/formantic-ui", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "components,semantic.css,semantic.js,semantic.min.css,semantic.min.js,themes")},
       ...
       {"/superkraft/frontend/libs/jquery", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "AUTHORS.txt,LICENSE.txt,bower.json,dist,external,jquery-ui,jquery.min.js,package.json,src")},
       ...
       {"/superkraft/frontend/libs/jquery/external/sizzle", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "LICENSE.txt,dist")},
       ...
       {"/superkraft/frontend/libs/jquery/jquery-ui", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "AUTHORS.txt,LICENSE.txt,external,index.html,jquery-ui.css,jquery-ui.js,jquery-ui.min.css,jquery-ui.min.js,jquery-ui.structure.css,jquery-ui.structure.min.css,package.json")},
       ...
       {"/superkraft/frontend/libs/jquery/src", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "ajax,ajax.js,attributes,attributes.js,callbacks.js,core,core.js,css,css.js,data,data.js,deferred,deferred.js,deprecated,deprecated.js,dimensions.js,effects,effects.js,event,event.js,exports,jquery.js,manipulation,manipulation.js,offset.js,queue,queue.js,selector-native.js,selector-sizzle.js,selector.js,serialize.js,traversing,traversing.js,var,wrap.js")},
       {"/superkraft/frontend/libs/jquery/src/ajax", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "jsonp.js,load.js,script.js,var,xhr.js")},
       ...
       {"/superkraft/frontend/libs/jquery/src/core", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "DOMEval.js,access.js,camelCase.js,init.js,isAttached.js,nodeName.js,parseHTML.js,parseXML.js,ready-no-deferred.js,ready.js,readyException.js,stripAndCollapse.js,support.js,toType.js,var")},
       {"/superkraft/frontend/libs/jquery/src/core/var", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "rsingleTag.js")},
       {"/superkraft/frontend/libs/jquery/src/css", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "addGetHookIf.js,adjustCSS.js,curCSS.js,finalPropName.js,hiddenVisibleSelectors.js,showHide.js,support.js,var")},
       ...
       {"/superkraft/frontend/libs/jquery/src/data", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "Data.js,var")},
       ...
       {"/superkraft/frontend/libs/jquery/src/manipulation", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "_evalUrl.js,buildFragment.js,getAll.js,setGlobalEval.js,support.js,var,wrapMap.js")},
       ...
       {"/superkraft/frontend/libs/jquery/src/traversing", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "findFilter.js,var")},
       ...
       {"/superkraft/modules", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "sk_cdnExporter.js,sk_fs,sk_ipc,sk_rootAction.js,sk_root_POST.js,sk_stats.js,sk_terminal.js,sk_timers.js,sk_ums.js,sk_utils.js,sk_validator.js")},
       ...
       {"/superkraft/ui/frontend/core", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "sk_ui.css,sk_ui_button,sk_ui_canvas,sk_ui_checkbox,sk_ui_checkmark,sk_ui_colorPicker,sk_ui_colors.css,sk_ui_component,sk_ui_contextMenu,sk_ui_dappTitlebar,sk_ui_dropdown,sk_ui_eventBlocker,sk_ui_fileDrop_Area,sk_ui_gradients.css,sk_ui_group,sk_ui_groupCollapsable,sk_ui_hint,sk_ui_iceRink,sk_ui_icon,sk_ui_iconButton,sk_ui_image,sk_ui_infoLabel,sk_ui_input,sk_ui_l10n_selector,sk_ui_label,sk_ui_labelledSwitch,sk_ui_languageAndCurrencyDropdown,sk_ui_linkButton,sk_ui_list,sk_ui_loader,sk_ui_menu,sk_ui_miniActionBtn,sk_ui_modal,sk_ui_pixi_canvas,sk_ui_progressBar,sk_ui_prompter,sk_ui_rating,sk_ui_roundedBtn,sk_ui_ruler,sk_ui_segment,sk_ui_segmentField,sk_ui_separator,sk_ui_shadows.css,sk_ui_simpleActionBtn,sk_ui_simpleActionIconBtn,sk_ui_simpleButton,sk_ui_slider,sk_ui_spacer,sk_ui_statusIndicator,sk_ui_successMessage,sk_ui_svg,sk_ui_switch,sk_ui_table,sk_ui_text,sk_ui_textarea")},
       ...
       {"/superkraft/ui/frontend/core/sk_ui_list", new SK_SoftBackend_Bundle_Entry_Info(0, 0, 0, 0,0, true, "", "sk_ui_list.css,sk_ui_list.js,sk_ui_listItem")},
